...
namespace ADO.NET
{
    public class AccessHelper
    {
        ...
        public AccessHelper(string connectString)
        {
        ...
        public DataTable ExecSQL(string commandString, IEnumerable<OleDbParameter> parameters = null)
        {
            OleDbConnection conn = new OleDbConnection(DBConnectString);
            ...
            if (parameters != null)
            {
                foreach (OleDbParameter x in parameters)
                {
        ...
        public int GetAffectedRows(string commandString, IEnumerable<OleDbParameter> parameters = null)
        {
            int affectedRows = 0;
            OleDbConnection conn = new OleDbConnection(DBConnectString);
            OleDbCommand cmd = new OleDbCommand(commandString, conn)
        ...
        /// <returns>DataTable</returns>
        public DataTable ExecProc(string procudure, IEnumerable<OleDbParameter> parameters = null)
        {
            OleDbConnection conn = new OleDbConnection(DBConnectString);
            OleDbCommand cmd = new OleDbCommand(procudure, conn)
            {
        ...
        public List<T> ExecSQL<T>(string commandString, IEnumerable<OleDbParameter> parameters = null) where T : class, new()
        {
